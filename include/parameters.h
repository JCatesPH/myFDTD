...
// --- Domain size ---
#define NZ 5570      // Number of x grid points
#define NOUT 75    // Number of time steps where output is stored
#define DOUT 500   // Spacing between time steps saved
#define LZ 95        // Num cells in PML
#define BZ 190     // Num of cells in "buffer" (SF but not PML)
#define DZ 10.0e-9     // x grid size
...
static const double I0    = 1.0e10;  //50e16;       // Mean pump intensity [W / m^2]
...
// --- Material Parameters ---
static const int    idie1 = 1500 + LZ + BZ;    // Index where dielectric starts
static const int    idie2 = 3500 + LZ + BZ;    // Index where dielectric starts
...
static const double eps_relDB = 3.61;
