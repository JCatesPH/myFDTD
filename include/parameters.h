...
// --- Domain size ---
#define NZ 9140      // Number of x grid points
#define NOUT 22     // Number of time steps where output is stored
#define DOUT 1500    // Spacing between time steps saved
#define LZ 190        // Num cells in PML
#define BZ 380     // Num of cells in "buffer" (SF but not PML)
#define DZ 5.0e-9     // x grid size
#define NF 500        // Number of frequencies
...
// --- Material Parameters ---
static const int    idie1 = 2000 + LZ + BZ;    // Index where dielectric starts
static const int    idie2 = 6000 + LZ + BZ;    // Index where dielectric starts
...
static const double n2 = 0.0; // 2.3e-20;      // Nonlinear index [m^2 / W]

static const double num_atoms = 2.1e26;
static const double mpi_sigmak = 0.0; //1.0e-224; // [m^(28) W^(-14) s^(-1)] MPI cross section
static const double mpi_k = 14.0; // Photons for MPI
static const double nu_e = 1.0 / 3e-15; // Mean collision time for electrons
#endif
